        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                Main.spriteBatch.Draw(
                    ...
                    + 7f * new Vector2(MathF.Sin(Main.GlobalTimeWrappedHourly * 1.5f + MathHelper.TwoPi * i / 4f), (float)Math.Cos(Main.GlobalTimeWrappedHourly * 1.5f + MathHelper.TwoPi * i / 4f)),
